...
> ⚠️ **최신 개선사항**: 이 문서는 초기 설계입니다. 최종 구현 스펙은 **`SNS_공유_개선사항_상세.md`** 참조
>
> 주요 개선사항:
> - **버튼 문구 변경** (14-34줄): "SNS에 바로 공유하기" → "SNS에 공유하기"
> - **상세 문구 설정** (36-280줄): 길이, 이모지, 미사여구/과한표현 자제, 커스텀 프롬프트
> - **3가지 문구 옵션** (284-511줄): 감성형(추천), 질문형, 간결형 중 선택
> - **AI 제작 표시** (515-747줄): 투명성 및 바이럴 마케팅 (워터마크, 푸터)
>
> **TODO**: 개선사항 내용을 이 파일에 반영하기 (다음 주 토큰 리셋 후 작업)
